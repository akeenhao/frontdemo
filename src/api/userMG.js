 ...
 **/
// 公司管理-获取公司列表
export const deptList = (params) => { return req("get", "/api/depts", params) };
// 公司管理-保存（添加编辑）
export const deptSave = (params) => { return axios.post("/api/depts", params) };
// 公司管理-删除公司
export const deptDelete = (params) => { return axios.delete("/api/depts/" + params).then(res => res.data) };
